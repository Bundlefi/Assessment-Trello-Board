...
import {isCreatingList, setCreatingList, getNewListName, setNewListName, getBoard} from '../../../../Redux'
...
return(
  ...
  <div>
        ...
        <AddComponent string='Add List' clickButton={buttonClick} clickClose={closeClick} />
        </div>
    ) : (
        <div onClick={addList}>
